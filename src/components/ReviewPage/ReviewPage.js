                    ...
                    <div className='reviewlist'>
                        <ul>
                            {this.state.editFeel ?
                                ...
                                color="primary" onClick={() => this.toggleBool('editFeel', false)}>edit</Button></li>
                                :
                                 <li>   <InputLabel id="demo-simple-select-label">Feelings</InputLabel>
                                 <Select labelId="demo-simple-select-label" 
                                 id="demo-simple-select" 
                                 value={this.state.feeling} 
                                 onChange={(event) => this.onInputChange(event, 'feeling', 'editFeel')}>
                            ...
                            {this.state.editUnderstanding ?
                                <li>Understanding: {understanding}
                                <Button variant="outlined" 
                                color="primary" 
                                onClick={() => this.toggleBool('editUnderstanding', false)}>edit</Button></li>
                                :
                                <li> <InputLabel id="demo-simple-select-label">Understanding</InputLabel>
                                <Select labelId="demo-simple-select-label" 
                                id="demo-simple-select" value={this.state.understanding} 
                                onChange={(event) => this.onInputChange(event, 'understanding', 'editUnderstanding')}>
                                    <MenuItem value={1}>Very Bad</MenuItem>
                                    <MenuItem value={2}>Bad</MenuItem>
                                    <MenuItem value={3}>Ok</MenuItem>
                                    <MenuItem value={4}>Good</MenuItem>
                            ...
                            {this.state.editSupport ?
                                <li>Support: {support}<Button variant="outlined" 
                                color="primary" onClick={() => this.toggleBool('editSupport', false)}>edit</Button></li>
                                :
                                <li> <InputLabel id="demo-simple-select-label">Support</InputLabel>
                                <Select labelId="demo-simple-select-label" 
                                id="demo-simple-select" value={this.state.support} 
                                onChange={(event) => this.onInputChange(event, 'support', 'editSupport')}>
                                    <MenuItem value={1}>Very Bad</MenuItem>
                                    <MenuItem value={2}>Bad</MenuItem>
                                    <MenuItem value={3}>Ok</MenuItem>
                                    <MenuItem value={4}>Good</MenuItem>
                            ...
                            {this.state.editComment ?
                                <li>Comments: {this.props.feedback.comment}
                                <Button variant="outlined" 
                                color="primary" 
                                onClick={() => this.toggleBool('editComment', false)}>edit</Button></li>
                                :
                                <li> <Textfield id="outlined-basic" 
                                label="change answer" type="text" 
                                onChange={(event) => this.onInputChange(event, 'comment', 'editComment')} />
                                    <Button variant="outlined" 
                                    color="secondary" 
                                    onClick={() => this.editButtonHandle('SET_COMMENT', this.state.comment)}>submit change</Button>
                                </li>}
                        </ul>
                        <br></br>
